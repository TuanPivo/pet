              ...
              tabs: [
                ScrollableListTab(
                  ...
                  body: ListView(
                    ...
                    children: [
                      Center(
                        child: Wrap(
                          children: productProvider.getdogList
                              .map((e) => SizedBox(
                                  width: 270,
                                  height: 300,
                ...
                ScrollableListTab(
                  ...
                  body: ListView(
                    ...
                    children: [
                      Center(
                        child: Wrap(
                          children: productProvider.getcatList
                              .map((e) => SizedBox(
                                  width: 270,
                                  height: 300,
                                  child: LocationWidget(product: e)))
                ...
                ScrollableListTab(
                  tab: ListTab(
                      ...
                      icon: Icon(FontAwesomeIcons.speakerDeck),
                      showIconOnList: true),
                  body: ListView(
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    children: [
                      Center(
                        child: Wrap(
                          children: productProvider.getaccessoriesList
                              .map((e) => SizedBox(
                                  width: 270,
                                  height: 300,
                                  child: LocationWidget(product: e)))
