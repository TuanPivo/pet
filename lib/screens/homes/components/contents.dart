...
class _ContentsState extends State<Contents> {
  ...
  void getCallAllFunction(ProductProvider initproductProvider) {
    ...
    initproductProvider.getAllNewsData();
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        child: Center(
          child: Wrap(
            children: [
              if (productProvider.getcatList.isEmpty)
                Center(
                  child: CircularProgressIndicator(),
                ),
              for (var e in productProvider.getcatList)
                SizedBox(
                    width: 270, height: 300, child: LocationWidget(product: e)),
              for (var e in productProvider.getaccessoriesList)
                SizedBox(
                    width: 270, height: 300, child: LocationWidget(product: e)),
              for (var e in productProvider.getdogList)
                //   SizedBox(
                //       width: 270, height: 300, child: LocationWidget(product: e)),
